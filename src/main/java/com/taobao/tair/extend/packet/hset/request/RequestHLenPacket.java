...
public class RequestHLenPacket extends BasePacket {
	...
	public RequestHLenPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_HLEN_PACKET;
	}

	public RequestHLenPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_HLEN_PACKET;
	}
