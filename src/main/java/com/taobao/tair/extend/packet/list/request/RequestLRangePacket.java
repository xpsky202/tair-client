...
public class RequestLRangePacket extends BasePacket {
	...
	public RequestLRangePacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_LRANGE_PACKET;
	}
	
	

	public RequestLRangePacket() {
		super();
		pcode = TairConstant.TAIR_REQ_LRANGE_PACKET;
	}
