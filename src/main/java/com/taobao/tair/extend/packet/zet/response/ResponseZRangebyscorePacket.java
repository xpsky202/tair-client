...
public class ResponseZRangebyscorePacket extends BasePacket {
	...
	public ResponseZRangebyscorePacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_RESP_ZRANGEBYSCORE_PACKET;
	}
