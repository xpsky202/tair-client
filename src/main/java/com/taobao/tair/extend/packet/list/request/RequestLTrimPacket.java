...
public class RequestLTrimPacket extends BasePacket {
	...
	public RequestLTrimPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_LTRIM_PACKET;
	}
	
	public RequestLTrimPacket() {
		pcode = TairConstant.TAIR_REQ_LTRIM_PACKET;
	}
