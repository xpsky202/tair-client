...
public class RequestZAddPacket extends BasePacket {
	private final static int HEADER_LEN = 1 + 2 + 2 + 4 + 4 + 4 + 8;
	...
	public RequestZAddPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_ZADD_PACKET;
	}

	public RequestZAddPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_ZADD_PACKET;
	}
	...
	public int encode() {
		...
		byteBuffer.put(BytesHelper.DoubleToBytes_With_Little_Endian(score));
