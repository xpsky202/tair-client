...
public class RequestZRemrangebyrankPacket extends BasePacket {
	...
	public RequestZRemrangebyrankPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_ZREMRANGEBYRANK_PACKET;
	}

	public RequestZRemrangebyrankPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_ZREMRANGEBYRANK_PACKET;
	}
