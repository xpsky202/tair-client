...
public class RequestHSetPacket extends BasePacket {
	...
	public RequestHSetPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_HSET_PACKET;
	}

	public RequestHSetPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_HSET_PACKET;
	}
	...
	public int encode() {
		...
		writePacketBegin(HEADER_LEN + keybytes.length + fieldbytes.length + valuebytes.length);
