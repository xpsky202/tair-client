...
public class RequestLRemPacket extends BasePacket {
	...
	public RequestLRemPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_LREM_PACKET;
	}
	
	public RequestLRemPacket() {
		pcode = TairConstant.TAIR_REQ_LREM_PACKET;
	}
