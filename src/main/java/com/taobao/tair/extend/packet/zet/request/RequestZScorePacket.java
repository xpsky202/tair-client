...
public class RequestZScorePacket extends BasePacket {
	...
	public RequestZScorePacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_ZSCORE_PACKET;
	}

	public RequestZScorePacket() {
		super();
		pcode = TairConstant.TAIR_REQ_ZSCORE_PACKET;
	}
