...
public class ResponseZRemrangebyrankPacket extends BasePacket {

	private int configVersion = 0;
	private int resultCode = 0;
	private long value = 0;
	
	public ResponseZRemrangebyrankPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_RESP_ZREMRANGEBYRANK_PACKET;
	}
