...
public class ResponseZRemrangebyscorePacket extends BasePacket {

	private int configVersion = 0;
	private int resultCode = 0;
	private long value = 0;
	
	public ResponseZRemrangebyscorePacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_RESP_ZREMRANGEBYSCORE_PACKET;
	}
