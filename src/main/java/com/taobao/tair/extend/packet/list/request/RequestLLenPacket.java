...
public class RequestLLenPacket extends BasePacket {
	private static final int HEADER_LEN = 1 + 2 + 4;
	
	protected short namespace = 0;
	protected Object key = null;
	
	public RequestLLenPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_LLEN_PACKET;
	}
	
	public RequestLLenPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_LLEN_PACKET;
	}
