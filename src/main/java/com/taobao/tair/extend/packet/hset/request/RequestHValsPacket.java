...
public class RequestHValsPacket extends BasePacket {
	...
	public RequestHValsPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_HVALS_PACKET;
	}

	public RequestHValsPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_HVALS_PACKET;
	}
