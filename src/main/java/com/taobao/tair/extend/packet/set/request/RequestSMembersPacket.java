...
public class RequestSMembersPacket extends BasePacket {
	...
	public RequestSMembersPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_SMEMBERS_PACKET;
	}

	public RequestSMembersPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_SMEMBERS_PACKET;
	}
