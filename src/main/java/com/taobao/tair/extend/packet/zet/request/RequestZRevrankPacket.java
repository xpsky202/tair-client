...
public class RequestZRevrankPacket extends BasePacket {
	...
	public RequestZRevrankPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_ZREVRANK_PACKET;
	}

	public RequestZRevrankPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_ZREVRANK_PACKET;
	}
