...
public class RequestSCardPacket extends BasePacket {

	private static final int HEADER_LEN = 1 + 2 + 4;
	
	public RequestSCardPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_SCARD_PACKET;
	}
	private short namespace = 0;
	private Object key = null;
	
	public RequestSCardPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_SCARD_PACKET;
	}
